const fr = {
  ...
  'whyUs.reason1Desc':
    'Nos guides passionnés donnent vie à l\'histoire et à la culture de l\'Égypte avec des connaissances privilégiées et des récits personnels.',
  'whyUs.reason2Title': 'Itinéraires sur mesure',
  'whyUs.reason2Desc':
    'Chaque voyage est conçu de manière unique pour correspondre à vos intérêts, votre rythme et votre style de voyage.',
  'whyUs.reason3Title': 'Hébergements de prestige',
  'whyUs.reason3Desc':
    'Nous collaborons exclusivement avec des hôtels 4 et 5 étoiles et des complexes de charme qui répondent à nos normes de qualité.',
  'whyUs.reason4Title': 'Service Concierge 24/7',
  'whyUs.reason4Desc':
    'Du moment de votre réservation jusqu\'à votre retour, notre équipe dévouée est disponible 24h/24 pour vous assister.',
  ...
  'testimonials.subtitle':
    'Histoires réelles de vrais aventuriers qui nous ont confié leurs vacances de rêve.',

  // ── Urgency ────────────────────────────────────────────────────────
  'urgency.title': 'Disponibilité Limitée',
  'urgency.subtitle':
    'Ne manquez pas nos forfaits saisonniers exclusifs',
  'urgency.cta': 'Réservez votre place maintenant',
  'urgency.spotsLeft': 'Plus que {spots} places pour {month}',

  // ── Contact ────────────────────────────────────────────────────────
  'contact.title': 'Commencez à planifier votre voyage de rêve',
  'contact.subtitle':
    'Remplissez le formulaire et nos experts en voyages créeront votre itinéraire parfait',
  ...
  // ── Footer ─────────────────────────────────────────────────────────
  'footer.description':
    'Dahab Dream Tour est votre partenaire de choix pour des expériences de voyage de luxe à travers l\'Égypte.',
  ...
  // ── Product Detail ─────────────────────────────────────────────────
  'product.experienceDetails': 'Détails de l\'expérience',
  'product.duration': 'Durée',
  'product.location': 'Lieu',
  'product.guests': 'Invités',
  'product.language': 'Langue',
  'product.startingFrom': 'À partir de',
  'product.person': 'personne',
  'product.travelDates': 'Dates de voyage',
  'product.selectDates': 'Sélectionner des dates',
  'product.travelers': 'Voyageurs',
  'product.adults': 'Adultes',
  'product.children': 'Enfants',
  'product.requestBooking': 'Demander une réservation',
  'product.secureTransaction': 'Transaction sécurisée',
  'product.freeCancellation': 'Annulation gratuite',
  'product.save': 'Enregistrer',
  'product.share': 'Partager',
  'product.overview': 'Aperçu',
  'product.itinerary': 'Itinéraire',
  'product.includes': 'Inclus',
  'product.reviews': 'Avis',
  'product.itineraryEmpty': 'L\'itinéraire sera mis à jour prochainement.',
  'product.noReviews': 'Pas encore d\'avis.',
  'product.day': 'Jour',
  'product.includesTitle': 'Ce qui est inclus ?',
  'product.reviewsTitle': 'Ce que disent les voyageurs',
  'product.guestsLabel': 'Jusqu\'à {count} personnes',
  'product.languagesList': 'Arabe, Anglais',
};
