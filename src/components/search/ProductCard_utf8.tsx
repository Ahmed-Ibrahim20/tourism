  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col p-8">
        ...
        <h3 className="mb-3 text-2xl font-black tracking-tight text-white transition-colors duration-300 group-hover:text-cyan-light">
          {t(product.titleKey)}
        </h3>

        <div className="mb-8 flex items-center gap-2.5 text-sm font-medium text-slate-400">
